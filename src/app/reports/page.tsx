                            ...
                            <div className="flex-1 mx-3 space-y-1">
                                <div className="bg-gray-200 rounded-full h-3 relative">
                                    <div
                                        ...
                                        style={{ width: `${maxValue > 0 ? (item.value1 / maxValue) * 100 : 0}%` }}
                                    ></div>
                                </div>
                                {item.value2 !== undefined && (
                                    <div className="bg-gray-200 rounded-full h-3 relative">
                                        <div
                                            ...
                                            style={{ width: `${maxValue > 0 ? (item.value2 / maxValue) * 100 : 0}%` }}
                                        ></div>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 rounded-lg text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{reportData?.performance?.revenueGrowth?.toFixed(1) || '0.0'}%</p>
                        ...
                        <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-lg text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{reportData?.performance?.profitMargin?.toFixed(1) || '0.0'}%</p>
                        ...
                        <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{reportData?.performance?.clientGrowth?.toFixed(1) || '0.0'}%</p>
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-lg text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{reportData?.performance?.collectionEfficiency?.toFixed(1) || '0.0'}%</p>
                        ...
                        {reportType === 'overview' && (
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <PieChartSimple
                                        data={[
                                            { label: 'Paid', value: reportData?.invoices?.paid || 0, color: 'bg-green-500' },
                                            { label: 'Pending', value: reportData?.invoices?.pending || 0, color: 'bg-yellow-500' },
                                            { label: 'Overdue', value: reportData?.invoices?.overdue || 0, color: 'bg-red-500' }
                                        ]}
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-lg font-bold text-green-600">₹{reportData?.accounting?.totalIncome?.toLocaleString() || '0'}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-gray-600">Total Expenses</span>
                                                <span className="text-lg font-bold text-red-600">₹{reportData?.accounting?.totalExpenses?.toLocaleString() || '0'}</span>
                                            </div>
                                            <div className="border-t pt-4">
                                                <div className="flex justify-between items-center">
                                                    <span className="text-lg font-semibold text-gray-900">Net Profit</span>
                                                    <span className={`text-xl font-bold ${(reportData?.accounting?.netIncome || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                                        ₹{reportData?.accounting?.netIncome?.toLocaleString() || '0'}
                                                    </span>
                                                </div>
                                                <div className="text-center mt-2">
                                                    <span className="text-sm text-gray-500">
                                                        Margin: {reportData?.performance?.profitMargin?.toFixed(1) || '0.0'}%
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.clients?.total || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                <p className="text-sm font-medium text-gray-600">Active Clients</p>
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.clients?.active || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.clients?.newThisMonth || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.clients?.inactive || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-lg font-bold text-gray-900">₹{((reportData?.invoices?.totalAmount || 0) / (reportData?.clients?.active || 1)).toLocaleString()}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-gray-600">Client Growth Rate</span>
                                                <span className="text-lg font-bold text-purple-600">{reportData?.performance?.clientGrowth?.toFixed(1) || '0.0'}%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6">
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.gstFilings?.total || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.gstFilings?.filed || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.gstFilings?.pending || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.gstFilings?.late || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm border">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="text-center">
                                            <p className="text-3xl font-bold text-gray-900">₹{reportData?.gstFilings?.totalTax?.toLocaleString() || '0'}</p>
                                            <p className="text-sm text-gray-600">Total GST Collected</p>
                                        </div>
                                        <div className="text-center">
                                            <p className="text-3xl font-bold text-green-600">{(((reportData?.gstFilings?.filed || 0) / (reportData?.gstFilings?.total || 1)) * 100).toFixed(1)}%</p>
                                            <p className="text-sm text-gray-600">Compliance Rate</p>
                                        </div>
                                        <div className="text-center">
                                            <p className="text-3xl font-bold text-blue-600">₹{((reportData?.gstFilings?.totalTax || 0) / (reportData?.gstFilings?.total || 1)).toLocaleString()}</p>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.payroll?.totalEmployees || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">₹{((reportData?.payroll?.totalGrossSalary || 0) / 1000).toFixed(0)}k</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">₹{((reportData?.payroll?.totalDeductions || 0) / 1000).toFixed(0)}k</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">₹{((reportData?.payroll?.totalNetSalary || 0) / 1000).toFixed(0)}k</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                {reportData?.payroll?.departmentWise?.map((dept, index) => (
                                                    <tr key={index} className="hover:bg-gray-50">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                            {((dept.salary / (reportData?.payroll?.totalGrossSalary || 1)) * 100).toFixed(1)}%
                                                        </td>
                                                    </tr>
                                                ))}
                                            </tbody>
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">₹{((reportData?.accounting?.totalIncome || 0) / 1000).toFixed(0)}k</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">₹{((reportData?.accounting?.totalExpenses || 0) / 1000).toFixed(0)}k</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className={`text-2xl font-bold ${(reportData?.accounting?.netIncome || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                                    ₹{((reportData?.accounting?.netIncome || 0) / 1000).toFixed(0)}k
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900">{reportData?.accounting?.totalTransactions || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody className="divide-y divide-gray-200">
                                                {reportData?.accounting?.categoryWise?.map((category, index) => (
                                                    <tr key={index} className="hover:bg-gray-50">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                            {((category.amount / (category.type === 'income' ? (reportData?.accounting?.totalIncome || 1) : (reportData?.accounting?.totalExpenses || 1))) * 100).toFixed(1)}%
                                                        </td>
                                                    </tr>
                                                ))}
                                            </tbody>
